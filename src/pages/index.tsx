  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Geometry Dash Platform, your go-to destination for a normal fun game that transforms your leisure time into an exciting adventure."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Geometry Dash Platform, your go-to destination for a normal fun game that transforms your leisure time into an exciting adventure.`}
            </Text>
            <Box
