...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'game_published.create': {
    roles: ['game-owner', 'game-administrator'],
    key: 'game_id',
    tenantPath: [],
    userPath: [],
  },
  'game_updated.update': { roles: ['game-owner', 'game-administrator'], key: 'game_id', tenantPath: [], userPath: [] },
  'purchase_made.create': { roles: ['game-owner'], key: 'purchase_id', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['game-owner'];
const customerRoles: string[] = ['customer'];
const tenantRoles: string[] = ['game-owner', 'game-administrator', 'game-developer'];
